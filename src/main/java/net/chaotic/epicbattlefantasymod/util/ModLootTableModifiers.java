...
public class ModLootTableModifiers {
    ...
    private static final Identifier DESERT_PYRAMID_SUS_ID =
            new Identifier("minecraft", "archaeology/desert_pyramid");
    private static final Identifier DESERT_WELL_SUS_ID =
            new Identifier("minecraft", "archaeology/desert_well");
    private static final Identifier OCEAN_RUIN_COLD_SUS_ID =
            new Identifier("minecraft", "archaeology/ocean_ruin_cold");
    private static final Identifier OCEAN_RUIN_WARM_SUS_ID =
            new Identifier("minecraft", "archaeology/ocean_ruin_warm");
    private static final Identifier TRAIL_RUINS_SUS_ID =
            new Identifier("minecraft", "archaeology/trail_ruins_common");
    private static final Identifier TRAIL_RUINS_RARE_SUS_ID =
    ...
    public static void modifyLootTables() {
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            ...
            if(VILLAGE_SNOWY_HOUSE_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        .rolls(ConstantLootNumberProvider.create(1))
                        .conditionally(RandomChanceLootCondition.builder(0.01f))
                        .with(ItemEntry.builder(ModItems.ESPRESSO))
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 1.0f)).build());
            ...
            if(PILLAGER_OUTPOST_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        .rolls(ConstantLootNumberProvider.create(1))
                        .conditionally(RandomChanceLootCondition.builder(0.5f))
                        .with(ItemEntry.builder(ModItems.BERZERKER))
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 1.0f)).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if(DESERT_PYRAMID_SUS_ID.equals(id)){
                ...
                entries.add(ItemEntry.builder(ModItems.HEAVENS_GATE).build());
                entries.add(ItemEntry.builder(ModItems.TOPAZ).build());
                entries.add(ItemEntry.builder(ModItems.HAND_BOMB).build());
                entries.add(ItemEntry.builder(ModItems.SACRED_RUNE).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (DESERT_WELL_SUS_ID.equals(id)) {
                List<LootPoolEntry> entries = new ArrayList<>(Arrays.asList(original.pools[0].entries));
                entries.add(ItemEntry.builder(ModItems.HEAVENS_GATE).build());
                entries.add(ItemEntry.builder(ModItems.LIQUID_ICE).build());
                entries.add(ItemEntry.builder(ModItems.THE_HOLY_GRAIL).build());
                entries.add(ItemEntry.builder(ModItems.RUBY).build());
                entries.add(ItemEntry.builder(ModItems.TOPAZ).build());
                entries.add(ItemEntry.builder(ModItems.SAPPHIRE).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (OCEAN_RUIN_COLD_SUS_ID.equals(id)) {
                List<LootPoolEntry> entries = new ArrayList<>(Arrays.asList(original.pools[0].entries));
                entries.add(ItemEntry.builder(ModItems.ICE_NEEDLE).build());
                entries.add(ItemEntry.builder(ModItems.SAPPHIRE).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (OCEAN_RUIN_WARM_SUS_ID.equals(id)) {
                List<LootPoolEntry> entries = new ArrayList<>(Arrays.asList(original.pools[0].entries));
                entries.add(ItemEntry.builder(ModItems.SAPPHIRE_SAINT).build());
                entries.add(ItemEntry.builder(ModItems.MOON_PEARL).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (TRAIL_RUINS_SUS_ID.equals(id)) {
                List<LootPoolEntry> entries = new ArrayList<>(Arrays.asList(original.pools[0].entries));
                entries.add(ItemEntry.builder(ModItems.EMERALD_SMASHER).build());
                entries.add(ItemEntry.builder(ModItems.SACRED_RUNE).build());
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (TRAIL_RUINS_RARE_SUS_ID.equals(id)) {
                List<LootPoolEntry> entries = new ArrayList<>(Arrays.asList(original.pools[0].entries));
                entries.add(ItemEntry.builder(ModItems.HEAVENS_GATE).build());
                entries.add(ItemEntry.builder(ModItems.OPAL).build());
